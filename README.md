...
* The dataset for the star network can be found in the R folder under 19821440_Singh 2009_Outcome data.RData. This folder contains extra .RData files that refer to the results of the multiple network meta-regression analyses to produce the Supplementary Table S1.
